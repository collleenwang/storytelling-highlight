...
var yPositionScale = d3.scaleLinear().domain([0, 85]).range([0, height]);

var colorScale = d3.scaleOrdinal().range(['#b2e2cd', '#fdcdac', '#cbd5e8', '#f4cae4', '#e6f5c9', '#fff2ae']);
...
function ready(datapoints) {
  ...
  svg.selectAll('rect').data(datapoints).enter().append('tect').attr('height', 20).attr('width', function (d) {
...
},{"d3":"../node_modules/d3/index.js","./countries.csv":"countries.csv"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","bar-chart.js"], null)
//# sourceMappingURL=/bar-chart.83326136.map